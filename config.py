...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6595741390').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "Bfowjdksbot") # without @
...
CLONE_DB_URI = environ.get("CLONE_DB_URI", "mongodb+srv://bikash:bikash@bikash.3jkvhp7.mongodb.net/?retryWrites=true&w=majori")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002247874129"))
